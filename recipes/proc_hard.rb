...
execute "sysctl_ip_forward" do
  user "root"
  command "/sbin/sysctl -w -e net.ipv4.ip_forward=#{ip_forwarding}"
...
execute "sysctl_send_redirects" do
  user "root"
  command "/sbin/sysctl -w -e net.ipv4.conf.all.send_redirects=#{send_redirects}"
...
execute "sysctl_send_default_redirects" do
  user "root"
  command "/sbin/sysctl -w -e net.ipv4.conf.default.send_redirects=#{send_redirects}"
...
execute "sysctl_icmp_redirect_accept" do
  user "root"
  command "/sbin/sysctl -w -e net.ipv4.conf.all.accept_redirects=#{icmp_redirect_accept}"
...
execute "sysctl_default_icmp_redirect_accept" do
  user "root"
  command "/sbin/sysctl -w -e net.ipv4.conf.default.accept_redirects=#{icmp_redirect_accept}"
...
execute "sysctl_icmp_secure_redirect_accept" do
  user "root"
  command "/sbin/sysctl -w -e net.ipv4.conf.all.secure_redirects=#{icmp_all_secure_redirect_accept}"
...
execute "sysctl_default_icmp_secure_redirect_accept" do
  user "root"
  command "/sbin/sysctl -w -e net.ipv4.conf.default.secure_redirects=#{icmp_all_secure_redirect_accept}"
...
execute "sysctl_log_suspicious_packets" do
  user "root"
  command "/sbin/sysctl -w -e net.ipv4.conf.all.log_martians=#{log_suspicious_packets}"
...
execute "sysctl_default_log_suspicious_packets" do
  user "root"
  command "/sbin/sysctl -w -e net.ipv4.conf.default.log_martians=#{log_suspicious_packets}"
...
execute "sysctl_rfc_source_route_validation" do
  user "root"
  command "/sbin/sysctl -w -e net.ipv4.conf.all.rp_filter=#{rfc_source_route_validation}"
...
execute "sysctl_default_rfc_source_route_validation" do
  user "root"
  command "/sbin/sysctl -w -e net.ipv4.conf.default.rp_filter=#{rfc_source_route_validation}"
...
execute "sysctl_ipv6_redirect_accept" do
  user "root"
  command "/sbin/sysctl -w -e net.ipv6.conf.all.accept_redirects=#{ipv6_redirect_accept};/sbin/sysctl -w net.ipv6.route.flush=1"
...
execute "sysctl_default_ipv6_redirect_accept" do
  user "root"
  command "/sbin/sysctl -w -e net.ipv6.conf.default.accept_redirects=#{ipv6_redirect_accept}; /sbin/sysctl -w net.ipv6.route.flush=1"
...
execute "sysctl_ipv6_router_advertisement" do
  user "root"
  command "/sbin/sysctl -w -e net.ipv6.conf.all.accept_ra=#{ipv6_ra_accept};/sbin/sysctl -w net.ipv6.route.flush=1"
...
execute "sysctl_default_ipv6_router_advertisement" do
  user "root"
  command "/sbin/sysctl -w -e net.ipv6.conf.default.accept_ra=#{ipv6_ra_accept};  /sbin/sysctl -w net.ipv6.route.flush=1"
